...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{formulacion/trees/img/arbol_problemas.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{formulacion/trees/img/Arbol_Soluciones.png}
